...
if __name__ == '__main__':
    ...
    copyfile("data/" + dname + '/' + oname + ".3D_Shape/" + oname + ".ply", mname)
    mesh = MeshPly(mname)
    vertices = np.c_[np.array(mesh.vertices), np.ones((len(mesh.vertices), 1))].transpose()
    corners3D = get_3D_corners(vertices)
    size3D = np.max(corners3D, axis=1) - np.min(corners3D, axis=1)
    diam = math.sqrt(sum(size3D * size3D))

    # load masks
    maskDir = "data/" + dname + '/' + oname + ".Mask"
    maskExt = ".png"
    ...
    # load images
    imgDir = "data/" + dname + '/' + oname + ".Images"
    imgExt = ".png"
    ...
    for i in imgList:
        ...
        jname = "data/" + dname + '/' + oname + '.3D_json/' + i[-21:-4] + '.json'
...
#    vertices = np.c_[np.array(mesh.vertices), np.ones((len(mesh.vertices), 1))].transpose()
#    indices = np.c_[np.array(mesh.indices), np.ones((len(mesh.indices), 1))].transpose()
#    corners3D = get_3D_corners(vertices)
#    np.savetxt('data/' + oname + '/' + oname + '.txt', np.transpose(corners3D))
#
...
#        img = cv.imread("data/{}/images/{}.png".format(name, valid_files[k][-17:-4]))
#        out = "data/{}/check/{}.png".format(name, valid_files[k][-17:-4])
#        gt = np.loadtxt("{}/test/gt/corners_{}.txt".format(backupdir, valid_files[k][-8:-4] ))
#        cv.line(img, (int(gt[1][0]),int(gt[1][1])), (int(gt[1][0]),int(gt[1][1])), [0, 255, 0], 10)
#        cv.line(img, (int(gt[2][0]),int(gt[2][1])), (int(gt[2][0]),int(gt[2][1])), [0, 255, 0], 10)
#        cv.line(img, (int(gt[3][0]),int(gt[3][1])), (int(gt[3][0]),int(gt[3][1])), [0, 255, 0], 10)
#        cv.line(img, (int(gt[4][0]),int(gt[4][1])), (int(gt[4][0]),int(gt[4][1])), [0, 255, 0], 10)
#        cv.line(img, (int(gt[5][0]),int(gt[5][1])), (int(gt[5][0]),int(gt[5][1])), [0, 255, 0], 10)
#        cv.line(img, (int(gt[6][0]),int(gt[6][1])), (int(gt[6][0]),int(gt[6][1])), [0, 255, 0], 10)
#        cv.line(img, (int(gt[7][0]),int(gt[7][1])), (int(gt[7][0]),int(gt[7][1])), [0, 255, 0], 10)
#        cv.line(img, (int(gt[8][0]),int(gt[8][1])), (int(gt[8][0]),int(gt[8][1])), [0, 255, 0], 10)
#        cv.line(img, (int(gt[1][0]),int(gt[1][1])), (int(gt[2][0]),int(gt[2][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[1][0]),int(gt[1][1])), (int(gt[3][0]),int(gt[3][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[2][0]),int(gt[2][1])), (int(gt[4][0]),int(gt[4][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[3][0]),int(gt[3][1])), (int(gt[4][0]),int(gt[4][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[5][0]),int(gt[5][1])), (int(gt[6][0]),int(gt[6][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[5][0]),int(gt[5][1])), (int(gt[7][0]),int(gt[7][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[6][0]),int(gt[6][1])), (int(gt[8][0]),int(gt[8][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[7][0]),int(gt[7][1])), (int(gt[8][0]),int(gt[8][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[1][0]),int(gt[1][1])), (int(gt[5][0]),int(gt[5][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[2][0]),int(gt[2][1])), (int(gt[6][0]),int(gt[6][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[3][0]),int(gt[3][1])), (int(gt[7][0]),int(gt[7][1])), [0, 255, 0], 2)
#        cv.line(img, (int(gt[4][0]),int(gt[4][1])), (int(gt[8][0]),int(gt[8][1])), [0, 255, 0], 2)
#        cv.putText(img, '1', (int(gt[1][0])+10,int(gt[1][1])+10), cv.FONT_HERSHEY_PLAIN, 3, [255, 0, 0], 3)
#        cv.putText(img, '2', (int(gt[2][0])+10,int(gt[2][1])+10), cv.FONT_HERSHEY_PLAIN, 3, [255, 0, 0], 3)
#        cv.putText(img, '3', (int(gt[3][0])+10,int(gt[3][1])+10), cv.FONT_HERSHEY_PLAIN, 3, [255, 0, 0], 3)
#        cv.putText(img, '4', (int(gt[4][0])+10,int(gt[4][1])+10), cv.FONT_HERSHEY_PLAIN, 3, [255, 0, 0], 3)
#        cv.putText(img, '5', (int(gt[5][0])+10,int(gt[5][1])+10), cv.FONT_HERSHEY_PLAIN, 3, [255, 0, 0], 3)
#        cv.putText(img, '6', (int(gt[6][0])+10,int(gt[6][1])+10), cv.FONT_HERSHEY_PLAIN, 3, [255, 0, 0], 3)
#        cv.putText(img, '7', (int(gt[7][0])+10,int(gt[7][1])+10), cv.FONT_HERSHEY_PLAIN, 3, [255, 0, 0], 3)
#        cv.putText(img, '8', (int(gt[8][0])+10,int(gt[8][1])+10), cv.FONT_HERSHEY_PLAIN, 3, [255, 0, 0], 3)
#        cv.imwrite(out, img)